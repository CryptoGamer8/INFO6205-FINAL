...
public class UI implements ActionListener {
    ...
    private void runBtnAction() {
        ...
        double d0 = Double.parseDouble(l1) ;
        if(flag == 0) {
            if(d0 < 2 || d0 >3 ) {
                r0c.setText("Input 2~3 !!!");
            ...
            System.out.println("R0 is "+ l1);

        }else if(flag == 1) {
            if(d0 < 1.8 || d0 >3.6) {
                r0c.setText("Input 1.8~3.6 !!!");
                JOptionPane.showMessageDialog(r0c, "SARS R0 should be 1.8~3.6!!!", "Error Alert", JOptionPane.WARNING_MESSAGE);
                throw new IllegalArgumentException("Invalid value");
            }
            System.out.println("R0 is "+ l1);
        }
        ...
        if(d2 > 10000 || d2 < 0 ) {
            r0s.setText("Input 0~10000 !!!");
            JOptionPane.showMessageDialog(r0s, "Cycles should be 0~10000!!!", "Error Alert", JOptionPane.WARNING_MESSAGE);
            throw new IllegalArgumentException("Invalid value");
        }
        System.out.println("Cycles is "+ l2);

        //JTextField --- Initial case
        String l3 = initialCase.getText();
        double d3 = Double.parseDouble(l3) ;
        if(d3 < 10 || d3 >1000 ) {
            initialCase.setText("Input 10~1000");
            JOptionPane.showMessageDialog(initialCase, "Initial case should be  10~1000 !!!", "Error Alert", JOptionPane.WARNING_MESSAGE);
            throw new IllegalArgumentException("Invalid value");
        }
        ...
        if(d4 < 500000 ) {
            population.setText("Input > 500000");
            JOptionPane.showMessageDialog(population, "Population should be > 500000 !!!", "Error Alert",JOptionPane.WARNING_MESSAGE);
            throw new IllegalArgumentException("Invalid value");
        }
